...
DUCKSTATION_CONF_OPTS += -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON
...
ifeq ($(BR2_PACKAGE_XORG7)$(BR2_PACKAGE_QT5),yy)
...
DUCKSTATION_CONF_OPTS += -DCMAKE_C_FLAGS="-DEGL_NO_X11=1"
DUCKSTATION_DEPENDENCIES += ecm weston sdl2 libevdev
